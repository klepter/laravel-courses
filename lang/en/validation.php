...
return [
    ...
    */
    ...
    'after' => ':attribute должно быть позже :date.',
    ...
    'email' => ':attribute должна быть почтовым адресом.',
    ...
    'min' => [
        ...
        'file' => ':attribute должен быть как минимум :min kilobytes.',
        'string' => ':attribute должен быть как минимум :min символов.',
        'array' => ':attribute должен быть как минимум :min items.',
    ],
    ...
    */
    ...
    'custom' => [
        ...
        'name' => [
            'cyrillic' => ':attribute должно содержать только кириллицу.'
        ],
    ],
